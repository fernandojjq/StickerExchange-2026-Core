export const Icons = {
    ...
    Flag: ({ className = "w-6 h-6" }) => (
        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1.665-1.684a2 2 0 012.632 0l2.738 2.737a2 2 0 010 2.737l-8.479 8.478a2 2 0 01-.666.369V21" />
        </svg>
    ),

    // Swap icon for repeated stickers
